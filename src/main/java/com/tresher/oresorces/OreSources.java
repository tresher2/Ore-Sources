...
@Mod(OreSources.MOD_ID)
public class OreSources {
    public static final String MOD_ID = "oresources";
    public static final Logger LOGGER = LogUtils.getLogger();

    // The constructor for the mod class is the first code that is run when your mod is loaded.
    // FML will recognize some parameter types like IEventBus or ModContainer and pass them in automatically.
    public OreSources(IEventBus modEventBus, ModContainer modContainer) {
    ...
    @EventBusSubscriber(modid = OreSources.MOD_ID, value = Dist.CLIENT)
    public static class ClientModClient {
        @SubscribeEvent
